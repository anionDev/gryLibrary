...
namespace GRYLibrary.Tests.Testcases
{
    ...
    public class XMLTests
    {
        ...
        {
            string testDataFolder = Path.Combine("Tests", "TestData", "XSDValidator", "Test1");
            ...
            Assert.IsTrue(Core.Utilities.ValidateXMLAgainstXSD(xmlWorking, xsd, out _));
            Assert.IsFalse(Core.Utilities.ValidateXMLAgainstXSD(xmlNotWorking, xsd, out _));
        }
        [TestMethod]
        public void TestXSLTValidator_Test1()
        {
            string testDataFolder = Path.Combine("Tests", "TestData", "XSLTTransformator", "Test1");
            ...
            Assert.AreEqual(xmlTarget, Core.Utilities.ApplyXSLTToXML(xmlSource, xslt));
        }
    }
}